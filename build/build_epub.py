...
BOOK_INTROS = {
    ...
    "갈라디아서": {"opening": "*율법인가 자유인가 — 바울의 가장 격렬한 편지.*",
        "overview": "갈라디아서는 바울이 갈라디아 교회에 보낸 분노의 편지(AD 49년경 또는 53년경). 이방 그리스도인에게 할례를 강요하는 자들과 정면 충돌. '그리스도께서 자유를 주려고 우리를 자유롭게 하셨으니 굳건하게 서서 다시는 종의 멍에를 메지 마라'(5:1). 종교개혁의 이신칭의 또 하나의 토대.",
        "parts": [{"num": "전체", "title": "갈라디아서", "subtitle": "이신칭의·자유·성령의 열매", "range": (1, 6)}]},
    "에베소서": {"opening": "*가장 우주적인 신학 — 만물이 그리스도 안에서 통일.*",
        "overview": "에베소서는 옥중서신 중 하나. 1-3장 거대한 신학(예정·은혜·연합), 4-6장 실천(교회·결혼·가정·영적 전쟁). 대표 어구: '오직 은혜로'(2:8-9), '한 몸과 한 성령'(4:4), '하나님의 전신갑주'(6:11).",
        "parts": [{"num": "전체", "title": "에베소서", "subtitle": "거대한 신학과 실천", "range": (1, 6)}]},
    "빌립보서": {"opening": "*기쁨의 편지 — 옥중에서 보낸 사랑.*",
        "overview": "빌립보서는 바울의 옥중서신 중 가장 따뜻한 편지. '항상 기뻐하라'(4:4)가 핵심. 2:6-11 '그리스도 찬가'(케노시스 송영)는 신약에서 가장 오래된 그리스도 송가로 추정.",
        "parts": [{"num": "전체", "title": "빌립보서", "subtitle": "기쁨·케노시스·자족", "range": (1, 4)}]},
    "골로새서": {"opening": "*그리스도가 만유의 머리 — 우주적 그리스도의 송영.*",
        "overview": "골로새서는 옥중서신. 거짓 가르침(영지주의 전조·금욕·천사 숭배)에 맞서 그리스도의 충만함을 선포. 1:15-20 '그리스도 송가'가 정점 — '보이지 아니하는 하나님의 형상… 만물이 그로 말미암고'.",
        "parts": [{"num": "전체", "title": "골로새서", "subtitle": "그리스도 송가·새 사람", "range": (1, 4)}]},
    "데살로니가전서": {"opening": "*가장 오래된 신약 책 — 부활과 재림의 위로.*",
        "overview": "데살로니가전서는 신약에서 가장 먼저 기록된 책(AD 50-51년). 죽은 신자들의 운명과 재림의 위로. 4:13-18이 휴거 신학의 토대 본문.",
        "parts": [{"num": "전체", "title": "데살로니가전서", "subtitle": "재림과 위로", "range": (1, 5)}]},
    "데살로니가후서": {"opening": "*재림은 아직 — 일하지 않으면 먹지도 마라.*",
        "overview": "데살로니가후서는 재림이 임박했다는 오해를 바로잡는다. 불법의 사람·배교가 먼저 와야 한다. '일하지 않으면 먹지도 마라'(3:10)가 가장 자주 인용.",
        "parts": [{"num": "전체", "title": "데살로니가후서", "subtitle": "재림과 노동", "range": (1, 3)}]},
    "디모데전서": {"opening": "*젊은 목회자에게 — 교회를 어떻게 이끌 것인가.*",
        "overview": "디모데전서는 바울의 후계자 디모데에게 보낸 목회서신. 거짓 가르침·예배 질서·감독·집사·과부·연장자에 대한 실제 지침.",
        "parts": [{"num": "전체", "title": "디모데전서", "subtitle": "목회 지침", "range": (1, 6)}]},
    "디모데후서": {"opening": "*바울의 마지막 편지 — 죽음을 앞두고.*",
        "overview": "디모데후서는 바울의 마지막 편지로 추정. AD 67년경 로마에서 처형 직전. '나는 선한 싸움을 싸우고 나의 달려갈 길을 마치고 믿음을 지켰으니'(4:7) — 가장 자주 인용되는 작별의 말.",
        "parts": [{"num": "전체", "title": "디모데후서", "subtitle": "마지막 작별", "range": (1, 4)}]},
    "디도서": {"opening": "*그레데에 남긴 후계자에게 — 장로와 자기 절제.*",
        "overview": "디도서는 그레데(크레타) 섬 교회를 맡은 디도에게. 장로의 자격, 거짓 가르침, 노예와 시민의 윤리. 2:11-14 그리스도 강림의 두 번 — 첫 번째와 영광스러운 재림.",
        "parts": [{"num": "전체", "title": "디도서", "subtitle": "그레데의 목회", "range": (1, 3)}]},
    "빌레몬서": {"opening": "*도망친 노예 오네시모를 돌려보내며 — 가장 짧은 바울서신.*",
        "overview": "빌레몬서는 25절짜리 한 장. 바울이 도망친 노예 오네시모를 그의 주인 빌레몬에게 돌려보내며 형제로 받아들이라고 부탁. 신약 안의 노예제 신학의 핵심 텍스트.",
        "parts": [{"num": "전체", "title": "빌레몬서", "subtitle": "한 장의 부탁", "range": (1, 1)}]},
    "히브리서": {"opening": "*그리스도가 모세보다, 천사보다, 제사장보다 — 절대 비교의 책.*",
        "overview": "히브리서는 저자 미상(바울·바나바·아볼로·브리스길라 등 학설). 유대 그리스도인에게 그리스도의 우월성을 논증. 멜기세덱 제사장직, 새 언약, 11장 믿음의 영웅들이 정점.",
        "parts": [
            {"num": "1부", "title": "그리스도의 우월성", "subtitle": "천사·모세·제사장", "range": (1, 7)},
            {"num": "2부", "title": "새 언약과 믿음", "subtitle": "단번 제사·믿음의 사람들·인내", "range": (8, 13)},
        ]},
    "야고보서": {"opening": "*행함이 없는 믿음은 죽은 것이다 — 가장 실제적인 편지.*",
        "overview": "야고보서는 예수의 동생 야고보의 편지로 전승. 시험·말의 무게·차별·행함·기도. 루터가 '지푸라기 서신'이라고 부른 책 — 그러나 오늘날은 가장 실제적인 신약 책 중 하나로 평가.",
        "parts": [{"num": "전체", "title": "야고보서", "subtitle": "행함·말·기다림", "range": (1, 5)}]},
    "베드로전서": {"opening": "*고난받는 자들에게 — 살아 있는 소망.*",
        "overview": "베드로전서는 박해받는 디아스포라 그리스도인에게. 살아 있는 소망·산 돌·그리스도의 본·고난의 신학. AD 60년대 네로의 박해 시기 추정.",
        "parts": [{"num": "전체", "title": "베드로전서", "subtitle": "고난과 소망", "range": (1, 5)}]},
    "베드로후서": {"opening": "*거짓 교사에 대한 마지막 경고.*",
        "overview": "베드로후서는 거짓 교사의 위협, 재림의 지연, 그러나 새 하늘 새 땅의 약속. 3:8 '주께는 하루가 천 년 같고 천 년이 하루 같다'.",
        "parts": [{"num": "전체", "title": "베드로후서", "subtitle": "거짓 교사·재림", "range": (1, 3)}]},
    "요한일서": {"opening": "*하나님은 사랑이시다 — 사랑과 진리의 시험.*",
        "overview": "요한일서는 요한의 가장 깊은 편지. '하나님은 사랑이시라'(4:8, 4:16) 두 번 선언. 영지주의 초기 형태에 맞선 성육신 옹호.",
        "parts": [{"num": "전체", "title": "요한일서", "subtitle": "사랑과 빛", "range": (1, 5)}]},
    "요한이서": {"opening": "*택하심을 받은 부녀에게 — 가장 짧은 신약 편지 중 하나.*",
        "overview": "요한이서는 13절. 한 부녀(또는 교회)에게 보낸 짧은 편지. 진리와 사랑이 함께. 거짓 교사 환대 금지.",
        "parts": [{"num": "전체", "title": "요한이서", "subtitle": "한 장의 권면", "range": (1, 1)}]},
    "요한삼서": {"opening": "*가이오에게 — 손님 대접의 윤리.*",
        "overview": "요한삼서는 15절. 가이오의 환대를 칭찬, 디오드레베의 거만을 책망. 1세기 교회 내부 갈등의 작은 창.",
        "parts": [{"num": "전체", "title": "요한삼서", "subtitle": "가이오와 디오드레베", "range": (1, 1)}]},
    "유다서": {"opening": "*거짓 교사에 대한 격렬한 경고.*",
        "overview": "유다서는 25절. 예수의 동생 유다(야고보의 동생)의 편지로 전승. 외경 에녹서·모세 승천기를 인용. 거짓 교사들에 대한 맹렬한 정죄.",
        "parts": [{"num": "전체", "title": "유다서", "subtitle": "한 장의 경고", "range": (1, 1)}]},
    "요한계시록": {"opening": "*마지막 환상 — 그리고 새 하늘 새 땅.*",
        "overview": "요한계시록은 신약 마지막 책이자 유일한 묵시 문학. 일곱 교회·일곱 인·일곱 나팔·일곱 대접·짐승·바벨론의 멸망·천년왕국·새 예루살렘. 21-22장의 새 하늘 새 땅이 성경 전체의 결말.",
        "parts": [
            {"num": "1부", "title": "일곱 교회", "subtitle": "환상·일곱 편지", "range": (1, 3)},
            {"num": "2부", "title": "심판 환상", "subtitle": "일곱 인·나팔·대접", "range": (4, 18)},
            {"num": "3부", "title": "새 하늘 새 땅", "subtitle": "천년왕국·새 예루살렘", "range": (19, 22)},
        ]},
    "사도행전": {
